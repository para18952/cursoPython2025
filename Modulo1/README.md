...
```
cd existing_repo
git remote add origin https://students.hackaboss.com/bootcamps/dsb09rt/mod1-programacion-con-python.git
git branch -M main
...
- [ ] [Set up project integrations](https://students.hackaboss.com/bootcamps/dsb09rt/mod1-programacion-con-python/-/settings/integrations)
